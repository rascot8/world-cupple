  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center z-10 animate-float-up">
        <h1 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fifa-green to-fifa-neon uppercase tracking-widest mb-8 drop-shadow-[0_0_15px_rgba(57,255,20,0.5)]">
          Get Ready!
        </h1>
        
        <div className="w-32 h-32 rounded-full border-4 border-fifa-neon flex items-center justify-center bg-black/50 backdrop-blur-md shadow-[0_0_30px_rgba(57,255,20,0.4)]">
